        ...
        <div class="d-flex justify-content-between mt-2 mb-4">
          ...
          <div>
            <b-button
              ...
              v-if="selectedRow[0] && selectedCategory.c_status == 'active'"
            ...
            <b-button
              class="mr-2 info-btn"
              v-if="selectedRow[0]"
              v-b-modal.updateCategoryModal
            >
              Update</b-button
            >

            <b-button v-b-modal.addCategoryModal class="primary-btn"
      ...
      <template #modal-body>
        ...
        <div class="w-100 mt-4 d-flex justify-content-end">
          ...
          <b-button
            ...
            @click="deleteCategory(selectedCategory.category_id)"
          >
            Yes
          </b-button>
        </div>
